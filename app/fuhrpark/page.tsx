...
export const metadata: Metadata = {
  title: "Fuhrpark",
  description: "MAGOTransport Fuhrpark: 15 Lkw (4 große, 10 kleine, 1 Abschlepp-Lkw) und zwei große Anhänger für Auslieferung, Abschleppdienst und Fahrzeugtransport in Wien und Wien-Umgebung.",
};
