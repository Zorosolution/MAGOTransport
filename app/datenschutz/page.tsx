...
const abschnitte = [
  { heading: "1. Verantwortlicher", body: "MAGOTransport GmbH, Logistikstraße 1, 1220 Wien, Österreich\nE-Mail: office@magotransport.at\nTel.: +43 800 626 424" },
        ...
        <div className="max-w-3xl mx-auto px-6">
          <AnimatedSection>
            <div className="glass rounded-2xl p-6 border border-white/8 mb-5">
              <p className="text-slate-400 text-sm"><strong className="text-white">Gültig ab:</strong> 1. Juni 2025 · <strong className="text-white">Stand:</strong> Juni 2025</p>
            </div>
